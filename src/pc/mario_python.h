...
#define PYTHON_MARIO_ADD_INTERACTION_CONSTANTS(module) \
    ...
    \
    PYTHON_MARIO_ADD_CONSTANT(module, ATTACK_PUNCH); \
    PYTHON_MARIO_ADD_CONSTANT(module, ATTACK_KICK_OR_TRIP); \
    PYTHON_MARIO_ADD_CONSTANT(module, ATTACK_FROM_ABOVE); \
    PYTHON_MARIO_ADD_CONSTANT(module, ATTACK_GROUND_POUND_OR_TWIRL); \
    PYTHON_MARIO_ADD_CONSTANT(module, ATTACK_FAST_ATTACK); \
    PYTHON_MARIO_ADD_CONSTANT(module, ATTACK_FROM_BELOW); \
    \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_COIN); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_WATER_RING); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_STAR_OR_KEY); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_BBH_ENTRANCE); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_WARP); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_WARP_DOOR); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_DOOR); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_CANNON_BASE); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_IGLOO_BARRIER); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_TORNADO); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_WHIRLPOOL); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_STRONG_WIND); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_FLAME); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_SNUFIT_BULLET); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_CLAM_OR_BUBBA); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_BULLY); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_SHOCK); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_BOUNCE_TOP2); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_MR_BLIZZARD); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_HIT_FROM_BELOW); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_BOUNCE_TOP); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_DAMAGE); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_POLE); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_HOOT); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_BREAKABLE); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_KOOPA); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_KOOPA_SHELL); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_UNKNOWN_08); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_CAP); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_GRABBABLE); \
    PYTHON_MARIO_ADD_CONSTANT(module, INTERACT_TEXT); \
    \
    PYTHON_MARIO_ADD_CONSTANT(module, CAM_MOVE_RETURN_TO_MIDDLE); \
    PYTHON_MARIO_ADD_CONSTANT(module, CAM_MOVE_ZOOMED_OUT); \
    PYTHON_MARIO_ADD_CONSTANT(module, CAM_MOVE_ROTATE_RIGHT); \
    PYTHON_MARIO_ADD_CONSTANT(module, CAM_MOVE_ROTATE_LEFT); \
    PYTHON_MARIO_ADD_CONSTANT(module, CAM_MOVE_ENTERED_ROTATE_SURFACE); \
    PYTHON_MARIO_ADD_CONSTANT(module, CAM_MOVE_METAL_BELOW_WATER); \
    PYTHON_MARIO_ADD_CONSTANT(module, CAM_MOVE_FIX_IN_PLACE); \
    PYTHON_MARIO_ADD_CONSTANT(module, CAM_MOVE_UNKNOWN_8); \
    PYTHON_MARIO_ADD_CONSTANT(module, CAM_MOVING_INTO_MODE); \
    PYTHON_MARIO_ADD_CONSTANT(module, CAM_MOVE_STARTED_EXITING_C_UP); \
    PYTHON_MARIO_ADD_CONSTANT(module, CAM_MOVE_UNKNOWN_11); \
    PYTHON_MARIO_ADD_CONSTANT(module, CAM_MOVE_INIT_CAMERA); \
    PYTHON_MARIO_ADD_CONSTANT(module, CAM_MOVE_ALREADY_ZOOMED_OUT); \
    PYTHON_MARIO_ADD_CONSTANT(module, CAM_MOVE_C_UP_MODE); \
    PYTHON_MARIO_ADD_CONSTANT(module, CAM_MOVE_SUBMERGED); \
    PYTHON_MARIO_ADD_CONSTANT(module, CAM_MOVE_PAUSE_SCREEN); \
